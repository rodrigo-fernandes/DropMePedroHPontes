...
public class Program {
	...
	public static void main(String[] args) {
		...
		sb.append("(DropME - Connecting Clients to Clients)");
		sb.append("=========================================");
		sb.append("");
		sb.append("Welcome, first we need registrate you in or aplication");
		sb.append("");
		sb.append("You are a Supplier or a DropShipper?");
		sb.append("1. Register as a Supplier");
		sb.append("2. Register as a DropShipper");
		sb.append("");
		sb.append("=========================================");
		...
		if (option == '1') {
			...
			list.add(new SupplierRegistratio(companyName, name, email, password));
